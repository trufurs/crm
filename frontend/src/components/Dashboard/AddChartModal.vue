...
// Seed/re-seed the selection from the available options so every type has a
// default (including number_chart) and a stale value dropped by a server-side
// override doesn't linger.
watch(
  currentOptions,
  (options) => {
